...
RENT_FILE = "./AllResults/processed_rent_forecast.csv"
HOUSE_FILE = "./AllResults/house_price_yearly.csv"
...
df_results.to_csv("./AllResults/npv_results.csv", index=False)

print("📁 Saved: ./AllResults/npv_results.csv")
